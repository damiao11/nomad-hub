...
export const REGISTER_USERNAME_RULE = /^[A-Za-z0-9_\u4E00-\u9FFF]{2,20}$/;
export const REGISTER_USERNAME_ALLOWED_CHARS_RULE = /^[A-Za-z0-9_\u4E00-\u9FFF]+$/;
const RESERVED_USER_NAMES = new Set(['admin', 'administrator', 'root', 'system']);

export const getUsernameRuleError = (value: string) => {

...
export default function LoginPanel({
  ...
  return (
    <div className={isLoggedIn ? 'absolute right-4 top-4 z-[1000] rounded-xl border border-white/25 bg-white/50 p-3 shadow-sm backdrop-blur-md' : 'absolute left-1/2 top-1/2 z-[1000] -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-lg shadow-lg'}>
      {!isLoggedIn ? (

...
export default function MapSearchBar({
  ...
  return (
    <div className="absolute left-3 right-14 top-3 z-[1000] mobile-safe-top [--safe-top-base:0.75rem] md:left-5 md:right-auto md:top-5 md:w-[360px] md:max-w-[calc(100%-2.5rem)]">
